...
install_requires = []
tests_require = ["pytest", "pytest-cov", "pytest-flake8", "asynctest", "pymodbus"]
...
setuptools.setup(
    name="ts_MTAirCompressor",
    description="LSST main telescope air compressor",
    use_scm_version={
        "write_to": "python/lsst/ts/MTAirCompressor/version.py",
    ...
    data_files=[],
    scripts=["bin/run_mtaircompressor.py"],
    tests_require=tests_require,
    extras_require={"dev": dev_requires},
    license="GPL",
    project_urls={
        "Bug Tracker": "https://jira.lsstcorp.org/secure/Dashboard.jspa",
        "Source Code": "https://github.com/lsst-ts/ts_MTAirCompressor",
    },
)
